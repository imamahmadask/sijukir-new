<div>
    <div>
        <div class="px-5 mb-4 h-max">
            ...
            <form wire:submit="updateGallery" enctype="multipart/form-data">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <x-input type="date" name="tanggal" model="tanggal"
                ...
                <button type="submit"
                    ...
                    Edit
                    <div wire:loading wire:target="updateBerlangganan">
                        <div role="status">
