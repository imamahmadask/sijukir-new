<div>
    ...
    <div wire:ignore.self id="create-histori-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="create-histori-modal">
                ...
                <!-- Modal body -->
                <form wire:submit="addHistoriJukir" class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="no_surat"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No. Surat</label>
                            <x-input type="text" name="no_surat" model="no_surat" placeholder="Masukkan No. Surat" />
                        ...
                        <div class="col-span-2">
                            <label for="histori" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Isi Histori
                            </label>
