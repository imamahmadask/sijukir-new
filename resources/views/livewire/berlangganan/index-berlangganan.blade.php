<div>
    <div class="px-5 mb-4 h-max">
        ...
        {{-- Tambah Berlangganan --}}
        <a href="{{ route('berlangganan.create') }}" type="button"
                ...
                <tbody>
                    @foreach ($this->berlangganans as $berlangganan)
                        <tr wire:key="{{ $berlangganan->id }}"
                            ...
                            <td class="px-6 py-4">
                                {{ \Carbon\carbon::parse($berlangganan->tgl_dikeluarkan)->format('d-m-Y') }}
                            </td>
                            <td class="px-6 py-4">
                                <div class="pl-3">
                            ...
                            <td class="px-6 py-4">
                                Rp. {{ number_format($berlangganan->jumlah) }}
                            </td>
                            <td class="px-6
                                    py-4 text-center">
                                <a type="button" href="berlangganan/{{ $berlangganan->id }}/edit"
                                ...
                                <button type="button" wire:click="deleteBerlangganan({{ $berlangganan->id }})"
