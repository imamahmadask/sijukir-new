<div>
    <div class="px-5 mb-4 h-max">
        ...
        <form wire:submit="editInsidentil">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <x-input type="text" name="no_surat" model="no_surat" placeholder="Masukkan Nomor Surat" />
                ...
                <div>
                    ...
                    <x-input type="date" name="tgl_surat" model="tgl_surat" placeholder="Masukkan Tanggal Surat" />
                    <x-input-error for="tgl_surat" />
                </div>
