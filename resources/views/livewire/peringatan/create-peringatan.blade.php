<div>
    <div class="px-5 mb-4 h-max">
        ...
        <form wire:submit="addPeringatan">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                @foreach ($tahun as $t)
                    <div>
                        <label for="kurang_setor_{{ $t }}"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Kurang Setor 2022
                        </label>
                        <input type="number" name="kurang_setor_{{ $t }}"
                            wire:model.live="kurang_setor_{{ $t }}"
                            class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Kurang setor 2023">
                        <x-input-error for="kurang_setor_{{ $t }}" />
                    </div>
                @endforeach
                    ...
                    @if ($banyak_cicilan)
                        @for ($i = 1; $i <= $banyak_cicilan; $i++)
                            <div>
                                ...
                                <x-input-error for="tgl_cicilan_{{ $i }}" />
                            </div>
                            ...
                            <div>
                                ...
                                <x-input-error for="jml_cicilan_{{ $i }}" />
                            </div>
                        @endfor
                    @endif
                @endif
            ...
            <button type="submit"
                ...
                Submit
                <div wire:loading wire:target="addPeringatan">
                    <div role="status">
