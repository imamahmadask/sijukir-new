<div>
    <div class="px-5 h-screen mb-4">
        ...
        <a href="{{ route('lokasi.create') }}" type="button"
        ...
        <!-- Filter -->
        <div class="overflow-x-auto my-4 relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div
                    ...
                    <div class="md:w-auto w-full">
                        <select wire:model.live='filter_area'
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="md:w-auto w-full">
                        <select wire:model.live='filter_korlap'
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="">Filter Korlap</option>
                            @foreach ($korlaps as $korlap)
                                <option value={{ $korlap->nama }}>{{ $korlap->nama }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    @foreach ($this->lokasis as $lokasi)
                        <tr
                            ...
                            <td class="px-6 py-4 text-center">
                                <!-- Modal toggle -->
                                <a href="lokasi/{{ $lokasi->id }}/edit" type="button"
                                ...
                                <button data-modal-target="delete-modal" data-modal-toggle="delete-modal"
                                    type="button" wire:click="deleteLokasi({{ $lokasi->id }})"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    Apakah Anda yakin ingin menghapus Lokasi {{ $lokasi_name }} ini?
                                                </h3>
                                                <button wire:click='destroyLokasi()' data-modal-hide="delete-modal"
                                                    type="button"
