<div>
    <div class="px-5 mb-4">
        ...
        <form wire:submit="updateMerchant">
            <input type="hidden" name="" wire:model="merchantId">
                ...
                <div class="sm:col-span-2">
                    ...
                    @if ($qris)
                        <div class="w-full lg:w-1/2">
                            <iframe src="/storage/{{ $qris }}" class="mt-2" frameborder="0" width="100%"
                                height="400px"></iframe>
                        </div>
                    @endif
                    <div wire:loading wire:target="qris">
                        <div role="status">
