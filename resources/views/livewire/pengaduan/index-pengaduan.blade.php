    ...
    <div class="px-5 mb-4 h-max">
        ...
        <div class="relative overflow-x-auto rounded-lg shadow-md">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($this->pengaduans as $pengaduan)
                        <tr wire:key="{{ $pengaduan->id }}"
                            ...
                            <td class="px-6 py-4">
                                ...
                                @elseif ($pengaduan->status == 'Belum Diproses')
                                    <span
                            ...
                            <td class="px-6 py-4 text-center">
                                <button wire:click="$dispatch('edit-pengaduan', { id: {{ $pengaduan->id }} })"
                                    data-modal-target="edit-pengaduan-modal" data-modal-toggle="edit-pengaduan-modal"
                                ...
                                @teleport('body')
                                    ...
                                    @livewire('pengaduan.edit-pengaduan')
                                @endteleport
                            </td>
                        </tr>
                    @endforeach
